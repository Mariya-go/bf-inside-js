...
console.assert(Object.is(_4_number, NaN), 'Test 4');

const _5_number = Number(false);
console.assert(Object.is(_5_number, NaN), 'Test 5');

const _6_number = Number('-1');
console.assert(Object.is(_6_number, NaN), 'Test 6');

const _7_number = Number('0');
console.assert(Object.is(_7_number, NaN), 'Test 7');

const _8_number = Number('');
console.assert(Object.is(_8_number, NaN), 'Test 8');
