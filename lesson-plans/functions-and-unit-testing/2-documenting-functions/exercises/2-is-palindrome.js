...
/**
 * This returns a boolean. This check, if parameter is a palindrome.
 *
 * @param {string} toCheck - string to check is it palindrom
 * @returns {boolean}  a buulean value depends of peremeter
 */
